...
build_clang_debug:
	...
	@LC_ALL=C scan-build --status-bugs --exclude ext/libevpl -disable-checker unix.BlockInCriticalSection -o ${CHIMERA_BUILD_DIR}/ClangDebug/ScanReport \
...
build_clang_release:
	...
	@LC_ALL=C scan-build --status-bugs --exclude ext/libevpl -disable-checker unix.BlockInCriticalSection -o ${CHIMERA_BUILD_DIR}/ClangRelease/ScanReport \
