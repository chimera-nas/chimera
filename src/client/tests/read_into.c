...
#ifdef _WIN32
/* LD_PRELOAD fault injection is only registered on Linux. */
static void (*chimera_test_reject_finishes)(
    int);
static void (*chimera_test_operation_eagain)(
    void);
static int  (*chimera_test_finish_attempts)(
    void);
static void (*chimera_test_finish_observer)(
    void (*)(void *),
    void *);
#else  /* ifdef _WIN32 */
