    ...
    struct chimera_client_request *request)
{
     ...
     * path did. */
    set_idx = chimera_vfs_compound_add_setattr(compound, NULL, &request->setattr.set_attr, 0, 0);
    ...
    struct chimera_client_request *request)
{
    ...
    int                          set_idx = chimera_vfs_compound_add_setattr(compound, NULL, &request->setattr.set_attr,
                                                                            0, 0);
