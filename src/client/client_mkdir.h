    ...
    struct chimera_client_request *request)
{
    ...
    chimera_vfs_compound_add_create_path(compound, CHIMERA_VFS_COMPOUND_CREATE_DIR, request->mkdir.path, request->mkdir.
                                         path_len, NULL, 0, &request->mkdir.set_attr, 0, 0);
