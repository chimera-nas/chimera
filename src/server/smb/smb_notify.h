...
uint32_t chimera_smb_notify_admit(
    struct chimera_server_smb_thread *thread,
...
void chimera_smb_notify_state_put(
    struct chimera_smb_notify_state *state);
struct chimera_smb_notify_state * chimera_smb_notify_detach(
    struct chimera_smb_open_file *open);
void chimera_smb_notify_admission_start(
