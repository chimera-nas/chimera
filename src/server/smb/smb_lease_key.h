...
void chimera_smb_lease_key_init(
    struct chimera_smb_lease_key_table *table);
void chimera_smb_lease_key_destroy(
    struct chimera_smb_lease_key_table *table);
...
void chimera_smb_lease_key_attach(
    struct chimera_smb_request           *request,
    struct chimera_smb_open_file         *open,
    const struct chimera_vfs_open_handle *handle);
SYMBOL_EXPORT void chimera_smb_lease_key_end(
    struct chimera_smb_request *request);
void chimera_smb_lease_key_open_release(
    struct chimera_smb_open_file *open);
