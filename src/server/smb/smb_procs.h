...
void chimera_smb_create_failed_open(struct chimera_smb_request *request, uint32_t status);
...
bool chimera_smb_create_cleanup_failed_record(struct chimera_smb_request *request, uint32_t status);
