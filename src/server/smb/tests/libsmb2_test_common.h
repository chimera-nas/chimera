...
static void auth_fn(const char *server, const char *share, char *workgroup,
                    int maxlen_workgroup, char *username, int maxlen_username,
                    char *password, int maxlen_password) {
...
static inline void libsmb2_test_init(struct test_env *env, char **argv,
                                     int argc) {
  int opt, rc;
  extern char *optarg;
...
static inline void libsmb2_test_cleanup(struct test_env *env,
                                        int remove_session) {
  int rc;
...
static inline void libsmb2_test_fail(struct test_env *env) {
...
static inline void libsmb2_test_success(struct test_env *env) {
