    ...
    struct smb2_conn *b)
{
    ...
    smb2_create(a, "o13-size-ii", MBT_FILE_CREATE, MBT_FILE_ALL_ACCESS,
                MBT_FILE_SHARE_RWD, &req, &first);
    ...
    smb2_create(a, "o13-size-ii", MBT_FILE_OVERWRITE, MBT_FILE_ALL_ACCESS,
                MBT_FILE_SHARE_RWD, &req, &first);
    smb2_quiesce(env);
    EXPECT(first.status == ST_SUCCESS && first.oplock == SMB2_OPLOCK_LEVEL_II &&
    ...
    req.lease_state  = SMB2_LEASE_READ;
    req.lease_epoch  = 1;
    smb2_create(a, "o13-size-key", MBT_FILE_CREATE, MBT_FILE_ALL_ACCESS,
                MBT_FILE_SHARE_RWD, &req, &first);
    smb2_create(a, "o13-size-key", MBT_FILE_OPEN, MBT_FILE_ALL_ACCESS,
                MBT_FILE_SHARE_RWD, &req, &second);
    ...
    req.lease_state  = SMB2_LEASE_RWH;
    smb2_create(a, "o13-stat-key", MBT_FILE_CREATE,
    ...
    req.lease_state  = SMB2_LEASE_RH;
    conflicting_open(env, b, a, "o13-stat-key", MBT_FILE_OPEN,
                     MBT_FILE_READ_ATTRIBUTES, MBT_FILE_SHARE_RWD,
