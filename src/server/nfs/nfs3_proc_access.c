 ...
 */
static void
chimera_nfs3_access_sequence_complete(
    ...
    void                        *private_data)
{
    ...
    /* Keep the compound alive through ACL evaluation; the attribute snapshot
     * owns its ACL only until compound_free. */
    ...
    void                      *private_data)
{
    ...
    chimera_vfs_compound_submit(compound,
                                chimera_nfs3_access_sequence_complete, ctx);
} /* chimera_nfs3_access */
