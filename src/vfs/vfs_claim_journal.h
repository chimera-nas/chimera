...
void chimera_vfs_claim_journal_seal(
    struct chimera_vfs_claim_journal *journal);
void chimera_vfs_claim_journal_publish(
    struct chimera_vfs_claim_journal *journal);
...
void chimera_vfs_claim_journal_complete(
    struct chimera_vfs_claim_journal *journal);
void chimera_vfs_claim_journal_reset(
    struct chimera_vfs_claim_journal *journal);
void chimera_vfs_claim_journal_free(
    struct chimera_vfs_claim_journal *journal);
