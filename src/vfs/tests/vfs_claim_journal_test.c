...
probe(struct chimera_vfs_file_state *file, uint64_t offset, uint64_t length, bool getlk)
{
...
static void
accept(struct chimera_vfs_claim_journal *j)
{
...
static void
unused_break(struct chimera_vfs_claim *claim, uint8_t mode, void *private)
{
...
main(int argc, char **argv)
{
    ...
    struct chimera_claim_actor compat_actor = { .owner = {
        .proto = CHIMERA_CLAIM_PROTO_SMB2, .client_key = 3, .owner_lo = 3 } };
