    ...
    void                        *private_data)
{
    ...
    chimera_nfs4_unmarshall_fh(remote_fh, ctx->server->index, request->fh, &request->lookup.r_attr);
    ...
    void                       *private_data)
{
    ...
    argarray[2].oplookup.objname.data = (void *) request->lookup.component;
    argarray[2].oplookup.objname.len  = request->lookup.component_len;
