...
bool chimera_vfs_claim_access_fence_acquire(
    ...
    struct chimera_vfs_file_state         *file,
    const void                            *cookie);
void chimera_vfs_claim_access_fence_release(
    struct chimera_vfs_claim_access_fence *fence);
...
void chimera_vfs_claim_access_owner_ref(
    struct chimera_vfs_claim_access_owner *owner);
void chimera_vfs_claim_access_owner_put(
    struct chimera_vfs_claim_access_owner *owner);
...
void chimera_vfs_claim_access_owner_retire(
    struct chimera_vfs_claim_access_owner *owner);
bool chimera_vfs_claim_access_owner_is_retired(
    struct chimera_vfs_claim_access_owner *owner);
 ...
 */
struct chimera_vfs_claim_access_journal * chimera_vfs_claim_access_journal_alloc(
    uint32_t capacity);
...
uint32_t chimera_vfs_claim_access_journal_excluded(
    ...
    uint32_t                                       capacity);
void chimera_vfs_claim_access_journal_seal(
    struct chimera_vfs_claim_access_journal *journal);
void chimera_vfs_claim_access_journal_publish(
    struct chimera_vfs_claim_access_journal *journal);
...
void chimera_vfs_claim_access_journal_complete(
    struct chimera_vfs_claim_access_journal *journal);
void chimera_vfs_claim_access_journal_reset(
    struct chimera_vfs_claim_access_journal *journal);
void chimera_vfs_claim_access_journal_free(
    struct chimera_vfs_claim_access_journal *journal);
