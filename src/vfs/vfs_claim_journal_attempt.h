...
void chimera_vfs_claim_range_attempt_execute(
    ...
    bool unlock, bool wait, uint32_t timeout_ms,
    void (*on_wait)(void *),
    bool (*is_canceled)(void *),
    void (*complete)(const struct chimera_vfs_claim_batch_result *, void *),
    void *private_data);
bool chimera_vfs_claim_range_attempt_cancel(struct chimera_vfs_claim_range_attempt *attempt);
void chimera_vfs_claim_range_attempt_free(struct chimera_vfs_claim_range_attempt *attempt);
