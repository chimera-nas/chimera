...
static void
chimera_posix_fdatasync_callback(
...
SYMBOL_EXPORT int
chimera_posix_fdatasync(int fd)
{
    ...
    req.commit.callback     = chimera_posix_fdatasync_callback;
    req.commit.private_data = &comp;

    chimera_posix_worker_enqueue(worker, &req, chimera_posix_fdatasync_exec);
