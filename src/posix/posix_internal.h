 ...
 * in this process), then confirmed with a CHIMERA_VFS_CAP_CLAIM_RANGE
 * backend so cross-PROCESS conflicts keep working (each process has its own
 * core instance; the backend is the shared arbiter).
 * -------------------------------------------------------------------- */
